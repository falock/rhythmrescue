...
public class MusicNote : MonoBehaviour
{
	...
	public void Initialize(TRIALConductor conductor, float startY, float endY, float removeLineY, float posX, float beat)
	{
    ...
    void Update()
	{
		...
		transform.position = new Vector2(transform.position.x, startY + (endY - startY) * (1f - (beat - conductor.songPosition / conductor.secPerBeat) / conductor.BeatsShownOnScreen));
