...
public class TRIALConductor : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (indexOfNextNote < track.Length && track[indexOfNextNote] < beatToShow)
		{
			...
			if (lane[g] == 1)
			{
				musicNote.Initialize(this, startLineY, finishLineY, removeLineY, lane1PosX, track[indexOfNextNote]);
			}
			else if (lane[g] == 2)
			{
				musicNote.Initialize(this, startLineY, finishLineY, removeLineY, lane2PosX, track[indexOfNextNote]);
			}
			else if (lane[g] == 3)
			{
				musicNote.Initialize(this, startLineY, finishLineY, removeLineY, lane3PosX, track[indexOfNextNote]);
			}
			else if (lane[g] == 4)
			{
				musicNote.Initialize(this, startLineY, finishLineY, removeLineY, lane4PosX, track[indexOfNextNote]);
			}
			else
			{
