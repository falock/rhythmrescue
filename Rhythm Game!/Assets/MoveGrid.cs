    ...
    public void Right()
    {
        if (trackingInt + 5 < cards.Count)
        {
            ...
            */
            ...
            cards[trackingInt - 1].GetComponent<FriendCardMove>().Move(positions[0].transform.position.x);
            cards[trackingInt].GetComponent<FriendCardMove>().Move(positions[1].transform.position.x);
            cards[trackingInt + 1].GetComponent<FriendCardMove>().Move(positions[2].transform.position.x);
            cards[trackingInt + 2].GetComponent<FriendCardMove>().Move(positions[3].transform.position.x);
            cards[trackingInt + 3].GetComponent<FriendCardMove>().Move(positions[4].transform.position.x);
            cards[trackingInt + 4].GetComponent<FriendCardMove>().Move(positions[5].transform.position.x);
            cards[trackingInt + 5].GetComponent<FriendCardMove>().Move(positions[6].transform.position.x);
